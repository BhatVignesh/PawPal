...
public class LittersSuppliesFragment extends Fragment implements DogFoodAdapter.OnItemClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_litters_supplies, container, false);

        recyclerView = view.findViewById(R.id.LitterRecyclerView);
