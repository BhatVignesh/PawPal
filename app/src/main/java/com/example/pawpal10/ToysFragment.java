...
public class ToysFragment extends Fragment implements DogFoodAdapter.OnItemClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.ToysRecyclerView);
        ...
        db.collection("product").document("toys").get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            @Override
