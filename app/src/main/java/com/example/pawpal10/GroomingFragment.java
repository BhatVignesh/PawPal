...
public class GroomingFragment extends Fragment implements DogFoodAdapter.OnItemClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.GroomingRecyclerView);
        ...
        db.collection("product").document("grooming").get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            @Override
